...
const disableScroll = () => {
  var _document2;
  const fixBlocks = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.querySelectorAll(".fixed-block");
...
const scroll = new (smooth_scroll__WEBPACK_IMPORTED_MODULE_4___default())('a[href*="#"]');
...
textMoreBtn.addEventListener("click", e => {
  ...
  moreText.classList.contains("feedback-item__more-text--active") ? textMoreBtn.innerHTML = "Скрыть текст" : textMoreBtn.innerHTML = "Читать полностью";
});
...
function bindModal(trigger, modal, close) {
  trigger = document.querySelectorAll(trigger), modal = document.querySelector(modal), close = document.querySelector(close);
  trigger.forEach(i => {
